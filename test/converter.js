...
describe("Converter", function() {
    ...
    it("Check num from 0 to 10**3 (kilo)", async function() {
    ...
    it("Check num from 10**3 to 10**6(mega)", async function() {
    ...
    it("Check num from 10**6 to 10**9(giga)", async function() {
    ...
    it("Check num from 10**9 to 10**12(teta)", async function() {
    ...
    it("Check num from 10**12 to 10**15(peta)", async function() {
    ...
    it("Check num from 10**15 to 10**18(exa)", async function() {
    ...
    it("Check num from 10**18 to 10**21(zetta)", async function() {
